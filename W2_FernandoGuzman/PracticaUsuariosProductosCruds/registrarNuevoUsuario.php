            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-9">
                                <h2 class="title-1 m-b-25">Registrar Usuario</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <div class="login-form">
                                        <form action="agregardb.php" method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                <label>Rol</label>
                                                <input class="au-input au-input--full" type="text" name="rol" placeholder="Rol">
                                            </div>
                                            <div class="form-group">
                                                <label>Imagen</label>
