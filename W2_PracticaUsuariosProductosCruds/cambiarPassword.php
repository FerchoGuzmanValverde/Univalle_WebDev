            ...
            <div class="main-content">
                <div class="section__content section__content--p30">
                    <div class="container-fluid">
                        <div class="row">
                            <div class="col-lg-9">
                                <h2 class="title-1 m-b-25">Cambiar Password</h2>
                                <div class="table-responsive table--no-card m-b-40">
                                    <div class="login-form">
                                        <form action="changePassword.php" method="post">
                                            <div class="form-group">
                                                <label>Usuario</label>
                                                <input class="au-input au-input--full" type="text" name="login" placeholder="User">
                                            </div>
                                            <div class="form-group">
                                                <label>Antiguo Password</label>
                                                <input class="au-input au-input--full" type="password" name="password" placeholder="Antiguo Password">
                                            </div>
                                            <div class="form-group">
                                                <label>New Password</label>
                                                <input class="au-input au-input--full" type="password" name="newPassword1" placeholder="New Password">
                                            </div>
                                            <div class="form-group">
                                                <label>Re-Enter New Password</label>
                                                <input class="au-input au-input--full" type="password" name="nesPassword2" placeholder="New Password">
                                            </div>
                                            <button class="au-btn au-btn--block au-btn--green m-b-20" type="submit">Cambiar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
