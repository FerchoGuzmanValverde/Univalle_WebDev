...
<body>
	...
	<?php
		...
		if($columnas>=1)
		{
			...
			header("Location: agregarProducto.php?error=1&nombres=$nombres&cantidad=$cantidad");
		}
		else
		{
			if($cantidad<=0)
			{
				header("Location: agregarProducto.php?error=2&nombres=$nombres&cantidad=$cantidad");
			}
			else
			{
