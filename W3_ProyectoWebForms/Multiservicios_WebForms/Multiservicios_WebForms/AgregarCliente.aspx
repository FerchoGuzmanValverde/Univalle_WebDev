<%@ Page Title="" Language="C#" MasterPageFile="~/Layout.Master" AutoEventWireup="true" CodeBehind="AgregarCliente.aspx.cs" Inherits="Multiservicios_WebForms.AgregarCliente" %>
    ...
    <div class="content">
        <div class="card">
                ...
                <div class="card-body table-responsive">
                      ...
                      <label>Celular:</label>
                      <input type="text" name="txtCelular" id="txtCelular" runat="server" />
